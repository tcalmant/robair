...
public class Sensor extends AbstractUPnPService {
	 ...
	 * constructor
	 */
	public Sensor(UPnPDevice upnpDevice, String serviceId, String serviceType,
			String version, SensorModel model) {
...

	{
		...
		public NameStateVariable(UPnPService upnpService, SensorModel model) {
	...
	implements UPnPStateVariableDescriptor {
		...
		public ValueStateVariable(UPnPService upnpService, SensorModel model) {
			super(upnpService, NAME, DATATYPE, null, // TODO defaultValue
														// changed for
					null, // TODO step changed for
					null, // TODO step changed for
	...
	implements UPnPStateVariableDescriptor {
		...
		public ErrorStateVariable(UPnPService upnpService, SensorModel model) {
			super(upnpService, NAME, DATATYPE, null, // TODO defaultValue
														// changed for
					null, // TODO step changed for
					null, // TODO step changed for
...

	{
		...
		public UnitStateVariable(UPnPService upnpService, SensorModel model) {
			super(upnpService, NAME, DATATYPE, null, // TODO defaultValue
														// changed for
					null, // TODO step changed for
					null, // TODO step changed for
	...
	implements UPnPStateVariableDescriptor {
		...
		public TimestampStateVariable(UPnPService upnpService, SensorModel model) {
			super(upnpService, NAME, DATATYPE, null, // TODO defaultValue
														// changed for
					null, // TODO step changed for
					null, // TODO step changed for
	...
	public class GetNameAction extends AbstractUPnPAction {
		...
		public GetNameAction(UPnPService upnpService, SensorModel model) {
	...
	public class GetApplicationAction extends AbstractUPnPAction {
		...
		public GetApplicationAction(UPnPService upnpService, SensorModel model) {
	...
	public class GetCurrentValueAction extends AbstractUPnPAction {
		...
		public GetCurrentValueAction(UPnPService upnpService, SensorModel model) {
