...
public class UPnPStateVariableTable {
	...
	public static String getUPnPDataType(String varname) throws IllegalArgumentException {
		...
		if(datatype==null) throw new IllegalArgumentException("No \""+varname+"\" statevariable" + ": statevariables are : "+listStateVariables());
		return datatype;
	}
	...
	public static String listStateVariables() {
		String s=null;
		Iterator iter=stateVariableTable.keySet().iterator();
		while(iter.hasNext()) s+=" "+(String) (iter.next());
		return s;
	}
