...
public class UPnPDataTypeUtil {
	...
	static {
		...
		dataTypeMap.put(UPnPStateVariable.TYPE_UI4, Integer.class);
	...
	static {
		...
		inputJavaTypeMap.put(UPnPStateVariable.TYPE_UI4, int.class);
	...
	static {
		...
		outputJavaTypeMap.put(UPnPStateVariable.TYPE_UI4, "IntegerHolder");
