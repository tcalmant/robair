...
import fr.imag.adele.util.upnp.AbstractUPnPAction;
import fr.imag.adele.util.upnp.AbstractUPnPService;
import fr.imag.adele.util.upnp.AbstractUPnPStateVariable;
...
public class PositionSensor extends AbstractUPnPService {
	...
	public PositionSensor(UPnPDevice upnpDevice, String serviceId,
		...
		stateVariables.put("CurrentLatitude", new CurrentLatitudeStateVariable(
				this, model));

		stateVariables.put("CurrentLongitude",
				new CurrentLongitudeStateVariable(this, model));

		stateVariables.put("CurrentAltitude", new CurrentAltitudeStateVariable(
				this, model));

		stateVariables.put("CurrentSpeed", new CurrentSpeedStateVariable(this,
				model));

		stateVariables.put("CurrentTrack", new CurrentTrackStateVariable(this,
				model));
		...
		actions.put("GetCurrentPosition", new GetCurrentPositionAction(this,
				model));

		actions.put("GetName", new GetNameAction(this, model));

		actions.put("SetName", new SetNameAction(this, model));
	...
	public class CurrentLatitudeStateVariable extends AbstractUPnPStateVariable
	...
	implements UPnPStateVariableDescriptor {
		...
		public CurrentLatitudeStateVariable(UPnPService upnpService,
			...
			super(upnpService, NAME, DATATYPE, null, // TODO defaultValue
					...
					true, // TODO sendEvent changed for yes OR
	...
	public class CurrentLongitudeStateVariable extends
	...
	implements UPnPStateVariableDescriptor {
		...
		public CurrentLongitudeStateVariable(UPnPService upnpService,
				PositionSensorModel model) {
			super(upnpService, NAME, DATATYPE, null, // TODO defaultValue
													 // changed for
					null, // TODO step changed for
	...
	public class CurrentAltitudeStateVariable extends AbstractUPnPStateVariable
	...
	implements UPnPStateVariableDescriptor {
		...
		public CurrentAltitudeStateVariable(UPnPService upnpService,
				PositionSensorModel model) {
			super(upnpService, NAME, DATATYPE, null, // TODO defaultValue
													 // changed for
					null, // TODO step changed for
	...
	public class CurrentSpeedStateVariable extends AbstractUPnPStateVariable
	...
	implements UPnPStateVariableDescriptor {
		...
		public CurrentSpeedStateVariable(UPnPService upnpService,
				PositionSensorModel model) {
			super(upnpService, NAME, DATATYPE, null, // TODO defaultValue
													 // changed for
					null, // TODO step changed for
	...
	public class CurrentTrackStateVariable extends AbstractUPnPStateVariable
	...
	implements UPnPStateVariableDescriptor {
		...
		public CurrentTrackStateVariable(UPnPService upnpService,
				PositionSensorModel model) {
			super(upnpService, NAME, DATATYPE, null, // TODO defaultValue
													 // changed for
					null, // TODO step changed for
...

	{
		...
		public NameStateVariable(UPnPService upnpService,
			...
			super(upnpService, NAME, DATATYPE, null, // TODO defaultValue
					...
					null, // TODO minimum changed for
					null, // TODO maximum changed for
					false, // TODO sendEvent changed for no OR
					true // TODO required changed for OR
			);
	...
	public class GetCurrentPositionAction extends AbstractUPnPAction {
		...
		public GetCurrentPositionAction(UPnPService upnpService,
				PositionSensorModel model) {
			super(upnpService, "GetCurrentPosition", "");
			this.model = model;

			addOutArg("CurrentLatitude", upnpService
					.getStateVariable("CurrentLatitude"));

			addOutArg("CurrentLongitude", upnpService
					.getStateVariable("CurrentLongitude"));

			addOutArg("CurrentAltitude", upnpService
					.getStateVariable("CurrentAltitude"));

			addOutArg("CurrentSpeed", upnpService
					.getStateVariable("CurrentSpeed"));

			addOutArg("CurrentTrack", upnpService
					.getStateVariable("CurrentTrack"));
		...
		public Dictionary invoke(Dictionary args) throws Exception {
			...
			model.getCurrentPosition(currentLatitude,
			...
			result.put("CurrentLatitude", currentLatitude.getObject());
			// java.lang.Float
			result.put("CurrentLongitude", currentLongitude.getObject());
			// java.lang.Float
			result.put("CurrentAltitude", currentAltitude.getObject());
			// java.lang.Float
			result.put("CurrentSpeed", currentSpeed.getObject());
			// java.lang.Float
			result.put("CurrentTrack", currentTrack.getObject());
			// java.lang.Float
			result.put("Timestamp", timestamp.getObject());
			// java.util.Date
	...
	public class SetNameAction extends AbstractUPnPAction {
		...
		public SetNameAction(UPnPService upnpService, PositionSensorModel model) {
			super(upnpService, "SetName", "");
			this.model = model;

			addInArg("NewName", upnpService.getStateVariable("Name"));
